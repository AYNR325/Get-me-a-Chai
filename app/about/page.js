...
const About = () => {
    return (
        <div className="container mx-auto px-8 md:px-4 py-8 ">
            <h1 className="text-3xl font-semibold mb-4 text-center">About Get Me a Chai</h1>
            <p className="text-lg mb-6 w-3/4 text-center mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex items-center mb-6 lg:w-1/2 lg:mx-auto">
